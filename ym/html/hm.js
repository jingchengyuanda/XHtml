(function() {
  var h = {},
    mt = {},
    c = {
      id: '2f8eec1c22efc7bd5da0c3b8301ff3ef',
      dm: ['demo.mycodes.net'],
  ...
  mt.h.bb = function(a) {
    return (a = mt.h.K(a, r)) && a.length ? String(a[0]) : '';
  };
  mt.h.ab = function(a) {
    return mt.h.K(a, u);
  };
  ...
  (function() {
    ...
    mt.f.Ba = /msie (\d+\.\d+)/i.test(navigator.userAgent)
    ...
    (function() {
      function b() {
        ...
        screen &&
          (screen.orientation && screen.orientation.angle !== q) &&
  ...
  (function() {
    ...
    function f(a) {
      if (
        ...
        (k = 'focus' == a.type || 'focusin' == a.type ? r : u), b();
    }
    var g = mt.event,
      n = h.H,
      l = r,
      ...
      e = {
        ...
        la: function() {
          ...
          if (a && a.cmd && a.cmd[c.id])
            for (
              var d = a.cmd[c.id],
                m = /^_track(Event|MobConv|Order|RTEvent)$/,
                b = 0,
                f = d.length;
              b < f;
              b++
        ...
        _trackPageview: function(a) {
          if (1 < a.length && a[1].charAt && '/' === a[1].charAt(0)) {
            ...
            h.b.a.vl = g.L() + g.M();
            h.b.a.kb = 0;
            h.b.N ? ((h.b.a.nv = 0), (h.b.a.st = 4)) : (h.b.N = r);
            var b = h.b.a.u,
              d = h.b.a.su;
        ...
        _setCustomVar: function(a) {
          if (!(4 > a.length)) {
            ...
            if (0 < b && 6 > b && 0 < m && 4 > m) {
              e.C++;
              for (
                var s = (h.b.a.cv || '*').split('!'), f = s.length;
                f < b - 1;
                f++
              )
                s.push('*');
        ...
        _trackMobConv: function(a) {
          if (
            ...
            (e.e |= 32), (h.b.a.et = 93), (h.b.a.ep = a), h.b.j();
        },
            ...
            if (900 >= m) g.call(this, a);
              ...
              for (
                var m = Math.ceil(m / 900),
                  s =
                    'block|' +
                    Math.round(Math.random() * n.Q).toString(16) +
                    '|' +
                    m +
                    '|',
                  l = [],
  ...
  (function() {
    ...
    a.prototype = {
      ...
      ta: function() {
        ...
        var a = u;
        this.A(document.referrer) && this.A(document.location.href)
          ? (a = r)
          : ((a = b.W(document.referrer)),
      ...
      setData: function(a, b, d) {
        try {
          n.set(a, b, { domain: this.J(), path: this.V(), I: d }),
            d ? p.set(a, b, d) : e.set(a, b);
        } catch (f) {}
      },
      Ha: function(a) {
        try {
          n.set(a, '', { domain: this.J(), path: this.V(), I: -1 }),
            e.remove(a),
            p.remove(a);
        } catch (b) {}
      },
      ...
      ga: function() {
        ...
        a &&
          (d.test(a) && e && g) &&
          ((this.a.rnd = Math.round(Math.random() * k.Q)),
        ...
        w = function(a, d) {
          ...
          if (d) {
            var k = d.getAttribute('href'),
              m = d.getAttribute('onclick')
                ? '' + d.getAttribute('onclick')
                : t,
              n = d.getAttribute('id') || '';
            l.test(k)
              ? ((e.sn = 'mediate'), (e.snv = k))
              : b.d(m, 'String') && l.test(m) && ((e.sn = 'wrap'), (e.snv = m));
            e.id = n;
          }
          h.b.a.et = 86;
