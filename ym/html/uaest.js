  ...
  if (typeof JSON2.parse !== 'function') {
    JSON2.parse = function(o, f) {
      ...
      if (
        ...
        n = eval('(' + o + ')');
        return typeof f === 'function' ? m({ '': n }, '') : n;
      }
  ...
  Piwik = (function() {
    ...
    function N(af) {
      ...
      for (ai = 0; ai < P - 3; ai += 4) {
        ah =
          (af.charCodeAt(ai) << 24) |
          (af.charCodeAt(ai + 1) << 16) |
          (af.charCodeAt(ai + 2) << 8) |
          af.charCodeAt(ai + 3);
        Y.push(ah);
      }
      switch (P & 3) {
        ...
        case 2:
          ai =
            (af.charCodeAt(P - 2) << 24) | (af.charCodeAt(P - 1) << 16) | 32768;
          break;
        case 3:
          ai =
            (af.charCodeAt(P - 3) << 24) |
            (af.charCodeAt(P - 2) << 16) |
            (af.charCodeAt(P - 1) << 8) |
            128;
          break;
      }
      ...
      for (U = 0; U < Y.length; U += 16) {
        ...
        for (ai = 0; ai <= 19; ai++) {
          aj =
            (R(ae, 5) + ((ad & ac) | (~ad & ab)) + aa + Q[ai] + 1518500249) &
            4294967295;
          aa = ab;
          ab = ac;
          ac = R(ad, 30);
        ...
        for (ai = 20; ai <= 39; ai++) {
          aj =
            (R(ae, 5) + (ad ^ ac ^ ab) + aa + Q[ai] + 1859775393) & 4294967295;
          aa = ab;
          ab = ac;
          ac = R(ad, 30);
          ad = ae;
        ...
        for (ai = 60; ai <= 79; ai++) {
          aj =
            (R(ae, 5) + (ad ^ ac ^ ab) + aa + Q[ai] + 3395469782) & 4294967295;
          aa = ab;
          ab = ac;
          ac = R(ad, 30);
          ad = ae;
    ...
    function w(T) {
      var P = 'Piwik_Overlay';
      var W = new RegExp(
        'index\\.php\\?module=Overlay&action=startOverlaySession&idsite=([0-9]+)&period=([^&]+)&date=([^&]+)$'
      );
    ...
    function y(an, aO) {
      var V = H(q.domain, B.location.href, t()),
        ...
        av = q.title,
        ax =
          '7z|aac|apk|ar[cj]|as[fx]|avi|bin|csv|deb|dmg|docx?|exe|flv|gif|gz|gzip|hqx|jar|jpe?g|js|mp(2|3|4|e?g)|mov(ie)?|ms[ip]|od[bfgpst]|og[gv]|pdf|phps|png|pptx?|qtm?|ra[mr]?|rpm|sea|sit|tar|t?bz2?|tgz|torrent|txt|wav|wm[av]|wpd||xlsx?|xml|z|zip',
        aR = [a8],
        Y = [],
        aJ = [],
        am = [],
      ...
      function bj() {
        var br,
          ...
          bq = new RegExp('Mac OS X.*Safari/').test(d.userAgent)
